...
<div id="page-wrapper">
            ...
            <div class="page-contentbar">
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                            <div id="outer">
                                <form method="post" action="<%= request.getContextPath() %>/freqInsert.no" onsubmit="return checkText();">
                                	<input type="hidden" name="userNo" value="<%= userNo %>">
                                    <div id="tagArea">
                                        <label>분류</label>
                                        <select name="boardTag" >
                                        	
                                            <option value="0" selected>결제</option>
                                    ...
                                    <div id="contentfooter">
                                        <div id="btnArea" align="center">
                                            <button id="cancel" type="button" onclick="location.href='<%= request.getContextPath() %>/allNotice.bo'">취소하기</button>                        
