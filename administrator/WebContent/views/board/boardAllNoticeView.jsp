                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
						...
						<div class="board-wrapper">
	                        ...
	                        <h2><a href="<%= request.getContextPath() %>/allNotice.bo">공지 관리</a></h2>
	                        <br>
	                                ...
	                                <% if(keyWord.equals("")) { %>
	                                	...
	                                	<% if(!blist.isEmpty() && listCount > 8) { %>
				                                ...
				                                <div id="buttonArea">          
				                                	...
				                                	<% }else { %>
				                                   		<button class="boardBtn" onclick="location.href='<%= request.getContextPath() %>/allNotice.bo?currentPage=<%= currentPage - 1 %>'">이전</button>
				                                	<% } %>  
				                                	...
				                                	<% for(int i = startPage; i <= endPage; i++) { %>
				                                		...
				                                		<% }else { %>
				                                			<button class="boardBtn" onclick="location.href='<%= request.getContextPath() %>/allNotice.bo?currentPage=<%= i %>'"><%= i %></button>
				                                		<% } %>                                                           
				                                	<% } %>
				                                	...
				                                	<% }else { %>
				                                    	<button class="boardBtn" onclick="location.href='<%= request.getContextPath() %>/allNotice.bo?currentPage=<%= currentPage + 1 %>'">다음</button>
				                                	<% } %>
				                                </div>
