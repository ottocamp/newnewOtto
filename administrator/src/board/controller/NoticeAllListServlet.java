...
/**
 * Servlet implementation class NoticeAllListServlet
 */
@WebServlet("/allNotice.bo")
public class NoticeAllListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = new BoardService().getAllNoticeCount();
		int currentPage;
		int startPage;
		int endPage;
		int maxPage;
		...
		ArrayList<Board> blist = new BoardService().getAllNotice(currentPage, boardLimit);
